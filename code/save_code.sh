...
fl_files=("submit_evaluation.sh" "run.py" "pipeline.py" "servers.py" "clients.py" "data_processing.py" "data_partitioning.py" "data_loading.py" "data_sets.py" "synthetic_data.py" "helper.py" "configs.py")
eval_files=("pipeline.py" "servers.py" "clients.py" "helper.py" "configs.py")
