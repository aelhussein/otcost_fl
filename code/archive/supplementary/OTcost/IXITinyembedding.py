...
class Autoencoder(nn.Module):
    def __init__(self, n_emb):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.BatchNorm1d(32 * 2 * 2 * 2),
            nn.LeakyReLU(0.2, inplace=True),

            nn.Unflatten(1, (32, 2, 2, 2)),

            nn.ConvTranspose3d(32, 64, kernel_size=(2, 3, 2), stride=2, padding=1, output_padding=0),
            nn.BatchNorm3d(64),
            nn.LeakyReLU(0.2, inplace=True),

            nn.ConvTranspose3d(64, 128, kernel_size=3, stride=2, padding=1, output_padding=0),
            nn.BatchNorm3d(128),
            nn.LeakyReLU(0.2, inplace=True),
